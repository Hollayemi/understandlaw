...
> = {
  ...
  awaiting_lawyer: { label: "Awaiting Lawyer", lawyerLabel: "Awaiting Lawyer", userLabel: "Lawyer is reviewing", bg: "#FFF0F5", text: "#9D174D", dot: "#9B2E3D", icon: Clock },
...
> = {
  ...
  recommended: {
    label: "Recommended", bg: "#FFF0F5", text: "#9D174D", dot: "#9B2E3D", icon: Users,
  },
  matched: {
