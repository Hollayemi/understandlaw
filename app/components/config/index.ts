...
> = {
  ...
  awaiting_lawyer: { label: "Awaiting Lawyer", lawyerLabel: "Awaiting Lawyer", userLabel: "Lawyer is reviewing", bg: "#FFF0F5", text: "#9D174D", dot: "#7C3AED", icon: Clock },
...
> = {
  ...
  recommended: {
    label: "Recommended", bg: "#FFF0F5", text: "#9D174D", dot: "#7C3AED", icon: Users,
  },
  matched: {
