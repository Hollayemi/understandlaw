...
export function ReplyPreview({
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2.5 bg-[#F9FAFB] border-t border-[#F3F4F6]">
      <div className="w-0.5 h-8 bg-maroon-500 rounded-full flex-shrink-0" />
      <div className="flex-1 min-w-0">
        <p className="text-[10px] font-bold text-maroon-500">Replying to {message.senderName}</p>
      ...
      <div className="flex items-end gap-2 px-4 py-3">
        <div className="flex-1 relative">
          <textarea
            ...
            rows={1}
            className="w-full px-4 py-2.5 rounded-2xl border-[1.5px] border-[#E5E7EB] text-[13px] text-[#111827] resize-none outline-none focus:border-maroon-500 placeholder:text-[#D1D5DB] transition-colors bg-white leading-relaxed"
            style={{ maxHeight: 120 }}
          />
        </div>
        <button
    ...
    <div className="flex !fixed w-full md:relative top-0 items-center gap-3 px-4 py-3.5 border-b border-[#F3F4F6] bg-white flex-shrink-0">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          ...
          {isAdmin && (
            <span className="text-[9px] font-bold text-maroon-500 bg-[#FFF0F5] border border-[#FBCFE8] px-1.5 py-0.5 rounded-full uppercase tracking-wider">
              Admin View
            </span>
          )}
          {caseInfo && (
  ...
  return (
    <button
      ...
      className={`w-full flex items-center gap-3 px-4 py-3.5 text-left transition-colors border-b border-[#F9FAFB] ${
        isActive
          ? "bg-[#FFF0F5] border-l-2 border-l-maroon-500"
          : "hover:bg-[#F9FAFB]"
      }`}
    >
      <div className="relative flex-shrink-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between gap-2 mt-0.5">
          ...
          {unreadCount > 0 && (
            <span className="flex-shrink-0 min-w-[18px] h-[18px] px-1 rounded-full bg-maroon-500 text-white text-[10px] font-bold flex items-center justify-center">
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-[#FAFAFA] gap-4">
      <div className="w-16 h-16 rounded-2xl bg-[#FFF0F5] flex items-center justify-center">
        <MessageSquare size={28} className="text-maroon-500" />
      </div>
