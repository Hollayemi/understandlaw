...
function WelcomeModal({ welcome }: { welcome: "user" | "lawyer" }) {
  ...
  const navBrief: NavBriefItem[] = isLawyer
    ? [
        { icon: Gavel, label: "My Briefs", desc: "View and respond to consultation requests from citizens." },
        { icon: BookOpen, label: "Learn", desc: "Browse learning resources and training material." },
        { icon: MessageSquareText, label: "Chat", desc: "Message citizens and the admin team." },
        { icon: MessageSquare, label: "Community", desc: "Join discussions with other lawyers." },
        { icon: Settings, label: "Settings", desc: "Manage your profile, KYC, and subscription." },
      ]
    : [
        { icon: Gavel, label: "Get a Lawyer", desc: "Request a consultation with an NBA-verified lawyer." },
        { icon: BookOpen, label: "Learn", desc: "Learn Nigerian law at your own pace." },
        { icon: BookMarked, label: "Library", desc: "Browse the legal document library." },
        { icon: MessageSquareText, label: "Chat", desc: "Message your lawyer once you're matched." },
        { icon: MessageSquare, label: "Community", desc: "Ask questions and connect with others." },
      ];
      ...
      <div className="w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl bg-white shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="relative px-6 pt-7 pb-5 border-b border-gray-50">
          ...
          <h2 className="text-xl font-bold text-gray-900">
            Welcome to LawTicha{user.firstName ? `, ${user.firstName}` : ""}!
          </h2>
        ...
        {isLawyer && (
          <div className="px-6 pb-2">
            <div className="rounded-xl border border-gray-100 bg-gray-50/60 p-4">
              <p className="text-xs font-bold text-gray-900 mb-3">Finish setting up your account</p>
              <div className="space-y-2">
                ...
                >
                  ...
                  <ArrowRight size={13} className="text-gray-300 group-hover:text-maroon-500 transition-colors" />
                </Link>
        ...
        <div className="px-6 pb-6 pt-4">
          ...
          >
            {isLawyer ? "Got it, take me to my dashboard" : "Got it, let's go"}
          </button>
        </div>
      </div>
    </div>
