...
const STEPS = [
  ...
  },
  {
    ...
    title: "Expert Help,\nWhen You're Ready",
    desc: "Browse SCN-verified lawyers by speciality, rating, and availability. Book via secure messaging, scheduled call, or video. transparent pricing, no hidden charges.",
    bullets: ["SCN-verified only", "Transparent fee schedule", "Messaging + video calls", "Verified reviews"],
    cta: "Find a Lawyer",
    href: "/marketplace",
    accent: "#10B981",
    ...
    <section className="bg-[#F3F3F3] py-20 xl:py-28">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.15em] text-[#F97316] mb-2">How It Works</p>
            <h2
