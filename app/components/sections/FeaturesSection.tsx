    ...
    <section className="bg-[#F3F3F3] py-20 xl:py-28">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-[#E8317A] mb-2">How It Works</p>
          ...
          <p className="text-sm text-gray-500 max-w-xs leading-relaxed">
            UnderstandLaw guides you from knowing your rights, to reading the law, to getting professional help — all in one platform.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-5">
          {STEPS.map((s) => (
            <div key={s.num} className="bg-white rounded-2xl p-7 flex flex-col border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              {/* Step + icon */}
              ...
              {/* Tag */}
              <p className="text-xs font-semibold mb-1.5" style={{ color: s.accent }}>{s.tag}</p>

              {/* Title */}
              <h3 className="text-xl font-bold text-gray-900 mb-3 whitespace-pre-line leading-snug"
