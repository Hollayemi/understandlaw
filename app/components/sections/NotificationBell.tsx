          ...
          >
                ...
                <>
                  ...
                  {hasMore && (
                    <button
                      ...
                      className="w-full py-2 text-xs text-[#F97316] hover:bg-gray-50 transition-colors border-t border-gray-100 disabled:opacity-50"
                    >
                      {isLoadingMore ? (
            ...
            <div className="px-4 py-2.5 border-t border-gray-100">
              <button
                ...
                className="w-full text-center text-xs text-[#F97316] hover:text-[#d02b6c] transition-colors font-medium"
              >
