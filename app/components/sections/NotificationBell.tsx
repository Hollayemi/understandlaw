  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      >
        ...
        {unreadCount > 0 ? (
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#E8317A] rounded-full animate-pulse" />
        ) : null}
      </button>
          ...
          >
            ...
            <div className="overflow-y-auto max-h-[350px]">
              {isLoading ? (
                <div className="flex items-center justify-center py-8">
                  <div className="w-6 h-6 border-2 border-[#E8317A] border-t-transparent rounded-full animate-spin" />
                </div>
                ...
                <>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-1.5">
                                ...
                                {notification.unread ? (
                                  <span className="w-1.5 h-1.5 bg-[#E8317A] rounded-full" />
                                ) : null}
                              </div>
                            </div>
                          </div>
                  ...
                  {hasMore && (
                    <button
                      ...
                      className="w-full py-2 text-xs text-[#E8317A] hover:bg-gray-50 transition-colors border-t border-gray-100 disabled:opacity-50"
                    >
                      {isLoadingMore ? (
                        <div className="flex items-center justify-center gap-2">
                          <div className="w-3 h-3 border-2 border-[#E8317A] border-t-transparent rounded-full animate-spin" />
                          Loading...
                        </div>
                      ) : (
                        'Load more'
            ...
            <div className="px-4 py-2.5 border-t border-gray-100">
              <button
                ...
                className="w-full text-center text-xs text-[#E8317A] hover:text-[#d02b6c] transition-colors font-medium"
              >
