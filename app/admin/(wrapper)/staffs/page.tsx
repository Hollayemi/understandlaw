...
const ROLE_CONFIG: Record<AdminRole, { label: string; icon: React.ElementType; color: string; bg: string }> = {
  ...
  [AdminRole.SUPPORT]: { label: "Support", icon: UserX, color: "#9B2E3D", bg: "#FFF0F5" },
};
              ...
              <>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-4 h-4 rounded border-[#E5E7EB] text-maroon-500 focus:ring-maroon-500"
                  />
        ...
        <div className="bg-white rounded-xl border border-[#F3F4F6] p-3 mb-5">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex-1 min-w-[200px]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-9 pl-9 pr-3 rounded-xl border border-[#E5E7EB] text-[12px] outline-none focus:border-maroon-500 transition-colors"
                />
              </div>
            </div>
            ...
            <select
              ...
              className="h-9 px-3 rounded-xl border border-[#E5E7EB] text-[12px] text-[#6B7280] bg-white outline-none focus:border-maroon-500 transition-colors"
            >
            ...
            <button
              onClick={() => refetch()}
              className="h-9 w-9 rounded-xl border border-[#E5E7EB] flex items-center justify-center text-[#6B7280] hover:border-maroon-500 hover:text-maroon-500 transition-colors"
            >
              <RefreshCw size={14} />
            </button>
          </div>
