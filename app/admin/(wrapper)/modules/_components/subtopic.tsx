  ...
  return (
    <div className="bg-[#F9FAFB] rounded-xl border border-[#F3F4F6] overflow-hidden">
      ...
      >
        ...
        <div className="w-5 h-5 rounded-full bg-maroon-500/10 flex items-center justify-center flex-shrink-0">
          <span className="text-[9px] font-bold text-maroon-500">{st.order}</span>
        </div>
        {editing ? (
          <input
            value={title}
            ...
            className="flex-1 text-[12px] font-semibold text-[#111827] bg-white border border-maroon-500 rounded-lg px-2 py-0.5 outline-none"
            autoFocus
          />
        ) : (
        ...
        <div className="px-4 pb-4 border-t border-[#F3F4F6]">
          <div className="mt-3">
            ...
            <textarea
              ...
              className="w-full h-28 px-3 py-2.5 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] resize-none outline-none focus:border-maroon-500 placeholder:text-[#D1D5DB] transition-colors bg-white"
            />
            <div className="flex items-center justify-between mt-2">
              ...
              <button
                ...
                className="flex items-center gap-1 text-[11px] font-semibold text-maroon-500 hover:underline disabled:opacity-50">
          ...
          <div className="p-5 grid lg:grid-cols-[1fr_320px] gap-6">
            ...
            <div>
              ...
              <div className="mb-5">
                ...
                <div className="flex gap-2 mb-3">
                  {([
                    ...
                    <button key={t.id}
                      ...
                      className={`flex items-center gap-1.5 px-3 py-2 rounded-xl border-[1.5px] text-[12px] font-semibold transition-all ${videoType === t.id ? "border-maroon-500 bg-pink-50 text-maroon-500" : "border-[#E5E7EB] text-[#6B7280] hover:border-[#9CA3AF]"}`}>
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full h-10 pl-9 pr-4 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] outline-none focus:border-maroon-500 placeholder:text-[#D1D5DB] transition-colors"
                      />
                    </div>
                    <button
                ...
                {videoType === "upload" && (
                  <div className="border-2 border-dashed border-[#E5E7EB] rounded-xl p-6 text-center hover:border-maroon-500 transition-colors cursor-pointer">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button onClick={addSubTopic}
                    className="flex items-center gap-1 text-[11px] font-semibold text-maroon-500 hover:underline">
                ...
                {subtopics.length === 0 ? (
                  <div className="border-2 border-dashed border-[#E5E7EB] rounded-xl p-6 text-center">
                    ...
                    <button onClick={addSubTopic}
                      className="mt-3 flex items-center gap-1.5 mx-auto text-[12px] font-semibold text-maroon-500 hover:underline">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full h-9 px-3 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] outline-none focus:border-maroon-500 bg-white transition-colors">
              ...
              <div className="flex flex-col gap-1.5">
                <Link href={`/admin/modules/${moduleId}/topics/${topic.id}`}
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-[#E5E7EB] text-[12px] font-semibold text-[#6B7280] hover:border-maroon-500 hover:text-maroon-500 transition-all">
