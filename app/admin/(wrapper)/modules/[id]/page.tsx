...
export default function ModuleDetailPage() {
    ...
    return (
      <div className="p-6 xl:p-8 max-w-7xl mx-auto text-center">
        <div className="bg-white rounded-2xl border border-[#F3F4F6] p-16">
          ...
          <Link href="/admin/modules" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#7C3AED] text-white text-[13px] font-semibold">
  ...
  const categoryConfig = CATEGORY_CONFIG[module.category] || { label: module.category, color: "#7C3AED", bg: "#FFF0F5" };
    ...
    <div className="p-6 xl:p-8 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-[#F3F4F6] overflow-hidden mb-6">
        ...
        <div className="p-5 grid lg:grid-cols-[1fr_auto] gap-5">
          ...
          <div className="grid grid-cols-4 gap-3 text-center">
            {[
              { v: topics.length, l: "Topics", icon: Layers, c: "#7C3AED" },
      ...
      {activeSection === "topics" && (
        <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 bg-[#F9FAFB] rounded-xl px-3 py-1.5 border border-[#F3F4F6]">
                ...
                <input
                  ...
                  className="w-16 h-7 px-2 rounded-lg border-[1.5px] border-[#E5E7EB] text-[11px] text-[#111827] outline-none focus:border-[#7C3AED] bg-white transition-colors"
                />
              </div>
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-[12px] font-bold text-white bg-[#7C3AED] hover:bg-[#5B21B6] transition-colors disabled:opacity-50"
              >
                {isGenerating ? (
              ...
              <button onClick={addTopic}
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-[12px] font-bold text-white bg-[#7C3AED] hover:bg-[#5B21B6] transition-colors">
          ...
          <button onClick={addTopic}
            className="mt-4 w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl border-2 border-dashed border-[#E5E7EB] text-[12px] font-semibold text-[#9CA3AF] hover:border-[#7C3AED] hover:text-[#7C3AED] hover:bg-pink-50/20 transition-all">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          <div className="flex-1 h-1 bg-[#F3F4F6] rounded-full overflow-hidden">
                            <div className="h-1 rounded-full bg-[#7C3AED]" style={{ width: `${l.progressPercentage}%` }} />
                          </div>
              ...
              <div className="p-5 space-y-4">
                <div>
                  ...
                  <input name="title" defaultValue={module.title}
                    className="w-full h-11 px-4 rounded-xl border-[1.5px] border-[#E5E7EB] text-[13px] text-[#111827] outline-none focus:border-[#7C3AED] transition-colors" />
                </div>
                <div>
                  ...
                  <select name="category" defaultValue={module.category}
                    className="w-full h-11 px-4 rounded-xl border-[1.5px] border-[#E5E7EB] text-[13px] text-[#111827] outline-none focus:border-[#7C3AED] bg-white transition-colors">
                ...
                <div>
                  ...
                  <textarea name="description" defaultValue={module.description}
                    className="w-full h-24 px-4 py-3 rounded-xl border-[1.5px] border-[#E5E7EB] text-[13px] text-[#111827] resize-none outline-none focus:border-[#7C3AED] transition-colors" />
                </div>
                <div>
                ...
                <div className="pt-2 flex items-center justify-between">
                  ...
                  <button type="submit"
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-[13px] font-bold text-white bg-[#7C3AED] hover:bg-[#5B21B6] transition-colors">
