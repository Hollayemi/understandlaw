        ...
        <div className="flex-1 min-w-0">
          {editingTitle ? (
            <input
              ...
              className="text-[13px] font-bold text-[#111827] bg-white border border-[#E8317A] rounded-lg px-2 py-0.5 outline-none w-64"
              autoFocus
            />
          ) : (
    ...
    return (
      <div className="p-6 xl:p-8 max-w-7xl mx-auto text-center">
        <div className="bg-white rounded-2xl border border-[#F3F4F6] p-16">
          ...
          <Link href={`/admin/modules/${moduleId}`} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#E8317A] text-white text-[13px] font-semibold">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <textarea name="overview" defaultValue={topic.overview}
                    className="w-full h-24 px-3 py-2 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] resize-none outline-none focus:border-[#E8317A] transition-colors" />
                </div>
                <div>
                    ...
                    return (
                      <div key={w.day} className="flex flex-col items-center gap-1.5 flex-1 group">
                        ...
                        <div
                          ...
                          style={{ height: `${Math.max(h, 4)}%`, background: isHighest ? "#E8317A" : "#F3F4F6", minHeight: 4 }}
                        />
                ...
                {topStates.map(s => (
                  <div key={s.state} className="mb-2.5">
                    ...
                    <div className="h-1.5 bg-[#F3F4F6] rounded-full overflow-hidden">
                      <div className="h-1.5 rounded-full bg-[#E8317A]/60" style={{ width: `${s.percentage}%` }} />
                    </div>
                  </div>
                ))}
              </div>
