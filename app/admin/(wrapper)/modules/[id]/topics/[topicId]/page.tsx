...
const CATEGORY_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
  ...
  consumer:    { label: "Consumer Rights",      color: "#F97316", bg: "#FFF0F5" },
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#F3F4F6] overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-5 py-4 border-b border-[#F9FAFB] cursor-pointer hover:bg-[#F9FAFB] transition-colors"
        ...
        <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-[#F97316] to-[#EA580C] flex items-center justify-center text-white text-[11px] font-bold flex-shrink-0">
          {st.order}
        </div>
        <div className="flex-1 min-w-0">
          {editingTitle ? (
            <input
              ...
              className="text-[13px] font-bold text-[#111827] bg-white border border-[#F97316] rounded-lg px-2 py-0.5 outline-none w-64"
              autoFocus
            />
          ) : (
          ...
          <div>
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full h-56 px-4 py-3.5 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] leading-relaxed resize-none outline-none focus:border-[#F97316] placeholder:text-[#D1D5DB] transition-colors font-mono"
              />
            </div>
            <div className="flex items-center justify-between mt-2.5">
              ...
              <button onClick={handleSaveNotes} disabled={saving}
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-[12px] font-bold text-white bg-[#F97316] hover:bg-[#d01f68] disabled:opacity-60 transition-colors">
    ...
    return (
      <div className="p-6 xl:p-8 max-w-7xl mx-auto text-center">
        <div className="bg-white rounded-2xl border border-[#F3F4F6] p-16">
          ...
          <Link href={`/admin/modules/${moduleId}`} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#F97316] text-white text-[13px] font-semibold">
          ...
          <div className="flex flex-col gap-3 lg:items-end">
            ...
            <div className="flex items-center gap-2">
              <select value={status} onChange={e => setStatus(e.target.value as TopicStatus)}
                className="h-9 px-3 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] outline-none focus:border-[#F97316] bg-white transition-colors">
            ...
            <div className="bg-white rounded-2xl border border-[#F3F4F6] p-5">
              ...
              <div className="flex gap-2 mb-4">
                {([
                  ...
                  <button key={t.id}
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border-[1.5px] text-[12px] font-semibold transition-all ${videoType === t.id ? "border-[#F97316] bg-pink-50 text-[#F97316]" : "border-[#E5E7EB] text-[#6B7280] hover:border-[#9CA3AF]"}`}>
                    <t.icon size={13} className={videoType === t.id ? "text-[#F97316]" : t.color} />
                    {t.label}
                  </button>
                ))}
              </div>
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input 
                        ...
                        className="w-full h-11 pl-9 pr-4 rounded-xl border-[1.5px] border-[#E5E7EB] text-[13px] text-[#111827] outline-none focus:border-[#F97316] placeholder:text-[#D1D5DB] transition-colors" />
                    </div>
                    <button 
              ...
              {videoType === "upload" && (
                <div>
                  ...
                  <div className="border-2 border-dashed border-[#E5E7EB] rounded-xl p-8 text-center hover:border-[#F97316] transition-colors cursor-pointer group">
                    <div className="w-12 h-12 rounded-2xl bg-[#F3F4F6] group-hover:bg-pink-50 flex items-center justify-center mx-auto mb-3 transition-colors">
                      <Video size={20} className="text-[#9CA3AF] group-hover:text-[#F97316] transition-colors" />
                    </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={addSubTopic}
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-[#E5E7EB] text-[12px] font-semibold text-[#6B7280] hover:border-[#F97316] hover:text-[#F97316] transition-all">
              ...
              {subtopics.length === 0 ? (
                <div className="bg-white rounded-2xl border-2 border-dashed border-[#E5E7EB] p-10 text-center">
                  ...
                  <button onClick={addSubTopic}
                    className="flex items-center gap-1.5 mx-auto px-4 py-2 rounded-xl text-[12px] font-bold text-white bg-[#F97316] hover:bg-[#d01f68] transition-colors">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input name="title" defaultValue={topic.title}
                    className="w-full h-10 px-3 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] outline-none focus:border-[#F97316] transition-colors" />
                </div>
                <div>
                  ...
                  <select name="classification" defaultValue={topic.classification}
                    className="w-full h-10 px-3 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] outline-none focus:border-[#F97316] bg-white transition-colors">
                ...
                <div>
                  ...
                  <textarea name="overview" defaultValue={topic.overview}
                    className="w-full h-24 px-3 py-2 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] resize-none outline-none focus:border-[#F97316] transition-colors" />
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl border border-[#F3F4F6] p-4">
              ...
              <div className="space-y-2.5">
                {[
                  ...
                  { label: "Sub-topics", value: subtopics.length, icon: Layers, c: "#F97316" },
                ].map(s => {
                  const Icon = s.icon;
                  return (
                    ...
                    return (
                      <div key={w.day} className="flex flex-col items-center gap-1.5 flex-1 group">
                        ...
                        <div
                          ...
                          style={{ height: `${Math.max(h, 4)}%`, background: isHighest ? "#F97316" : "#F3F4F6", minHeight: 4 }}
                        />
                    ...
                    return (
                      <div key={st.subtopicId}>
                        <div className="flex items-center justify-between text-[11px] mb-1.5">
                          <div className="flex items-center gap-2">
                            <span className="w-4 h-4 rounded-full bg-[#F97316]/10 flex items-center justify-center text-[9px] font-bold text-[#F97316]">{st.order}</span>
                        ...
                        <div className="h-2 bg-[#F3F4F6] rounded-full overflow-hidden">
                          <div className="h-2 rounded-full bg-[#F97316] transition-all"
                            style={{ width: `${dropPct}%` }} />
                        </div>
                        {i > 0 && (
                ...
                {topStates.map(s => (
                  <div key={s.state} className="mb-2.5">
                    ...
                    <div className="h-1.5 bg-[#F3F4F6] rounded-full overflow-hidden">
                      <div className="h-1.5 rounded-full bg-[#F97316]/60" style={{ width: `${s.percentage}%` }} />
                    </div>
                  </div>
                ))}
              </div>
