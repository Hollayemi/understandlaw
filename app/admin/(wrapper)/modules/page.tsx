...
export default function AdminModulesPage() {
  ...
  // Stats for StatBar
  const stats = [
    { label: "Total Modules", value: statsData?.data?.totalModules ?? 0, icon: BookOpen, color: "#7C3AED", bg: "#FFF0F5" },
      ...
      <div className="p-6 xl:p-8 max-w-7xl mx-auto">
        ...
        {modules.length === 0 ? (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            ...
            {/* Add new card */}
            <button onClick={() => setShowCreate(true)}
              className="rounded-2xl border-2 border-dashed border-[#E5E7EB] flex flex-col items-center justify-center p-8 text-center hover:border-[#7C3AED]/40 hover:bg-pink-50/20 transition-all group min-h-[320px]">
