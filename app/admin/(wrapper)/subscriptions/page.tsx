      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#7C3AED] text-white text-sm font-semibold hover:bg-[#d02a6e] transition-colors"
          >
            <Plus size={16} />
            Create Plan
          </Link>
      ...
      <div className="mb-6">
        <div className="relative max-w-md">
          ...
          <input
            ...
            placeholder="Search..."
            className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 text-sm outline-none focus:border-[#7C3AED] transition-colors"
          />
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
              ...
              <Link
                ...
                className="block text-center text-sm text-[#7C3AED] font-semibold hover:underline mt-4"
              >
                    ...
                    <td className="py-3 px-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          ...
                          className="p-1.5 rounded-lg text-gray-400 hover:text-[#7C3AED] hover:bg-pink-50 transition-colors"
                        >
                          <Eye size={16} />
                        </Link>
                        <Link
