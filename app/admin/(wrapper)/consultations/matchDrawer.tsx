  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      <div className="w-full max-w-xl bg-white h-full overflow-y-auto shadow-2xl flex flex-col">
        <div className="h-1 w-full flex-shrink-0" style={{ background: "linear-gradient(90deg, #7C3AED, #5B21B6)" }} />
        ...
        <>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full h-32 px-4 py-3 rounded-xl border-[1.5px] border-gray-200 text-sm resize-none outline-none focus:border-[#7C3AED] placeholder:text-gray-400 transition-colors"
            />
            <button
              onClick={handleSend}
        ...
        <>
          {scheduledCall && (
            <div className="bg-[#F9FAFB] border border-[#F3F4F6] rounded-xl p-4 space-y-1.5">
              ...
              {scheduledCall.link && (
                <a href={scheduledCall.link} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-[12px] text-[#7C3AED] font-semibold hover:underline">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full h-11 px-4 rounded-xl border-[1.5px] border-gray-200 text-sm text-gray-900 outline-none focus:border-[#7C3AED] transition-colors"
              />
            </div>
            <div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        {caseBrief && (
          <div className="mb-3">
            <AdminDocRow doc={caseBrief} badge={{ label: "Current brief", color: "#7C3AED", bg: "#FFF0F5" }} />
          </div>
        )}
        ...
        <div className="border-[1.5px] border-dashed border-gray-200 rounded-xl p-4 space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 pl-8 pr-3 rounded-lg border-[1.5px] border-gray-200 text-xs text-gray-900 outline-none focus:border-[#7C3AED] placeholder:text-gray-400 transition-colors"
            />
          </div>
          ...
          <input
            ...
            className="w-full h-10 px-3 rounded-lg border-[1.5px] border-gray-200 text-xs text-gray-900 outline-none focus:border-[#7C3AED] placeholder:text-gray-400 transition-colors"
          />

          <label className="flex items-center gap-2 cursor-pointer">
            <input type="checkbox" checked={isBrief} onChange={e => setIsBrief(e.target.checked)} className="accent-[#7C3AED] w-3.5 h-3.5" />
    ...
    <div className="space-y-4">
      {recommendedLawyers.length > 0 && (
        <div className="bg-[#FFF0F5] border border-[#FBCFE8] rounded-xl p-3.5 flex items-start gap-2.5">
          <Zap size={14} className="text-[#7C3AED] shrink-0 mt-0.5" />
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-10 pl-9 pr-4 rounded-xl border-[1.5px] border-gray-200 text-sm outline-none focus:border-[#7C3AED] placeholder:text-gray-400 transition-colors"
        />
      </div>

      {loadingLawyers ? (
        <div className="flex items-center justify-center py-10"><Loader2 size={20} className="animate-spin text-[#7C3AED]" /></div>
      ) : lawyers.length === 0 ? (
          ...
          {lawyers.map(l => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 p-3 rounded-xl border-[1.5px] text-left transition-all ${checked ? "border-[#7C3AED] bg-pink-50/60" : "border-[#F3F4F6] hover:border-gray-300"}`}
              >
                ...
                <div className={`w-5 h-5 rounded-md border-2 flex items-center justify-center flex-shrink-0 ${checked ? "bg-[#7C3AED] border-[#7C3AED]" : "border-gray-300"}`}>
