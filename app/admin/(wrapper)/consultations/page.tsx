  ...
  return (
    <>
      ...
      <div className="p-6 xl:p-8 max-w-7xl mx-auto">
        ...
        <StatBar items={[
          { label: "Total Sessions", value: total, icon: MessageSquare, color: "#F97316", bg: "#FFF0F5" },
          ...
          <>
            <div className="flex flex-col sm:flex-row gap-3 mb-5">
              ...
              <select value={modeFilter} onChange={e => setModeFilter(e.target.value as ConsultMode | "all")}
                className="h-9 px-3 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#6B7280] bg-white outline-none focus:border-[#F97316] transition-colors ml-auto">
