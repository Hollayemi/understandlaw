...
export default function AdminDashboardPage() {
  ...
  const revenueSegments = [
    { label: "Commission", value: ov?.revenue.platformCommission || 0, color: "#E8317A" },
  ...
  return (
    <div className="p-6 xl:p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <StatCard icon={Users}        label="Total Citizens"     value={ov?.citizens.total       || 0} sub={`+${ov?.citizens.newThisWeek || 0} this week`}              trend={ov?.citizens.growthPercent}    trendLabel="vs last period" color="#E8317A" bg="#FFF0F5" href="/admin/citizens" />
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-[#F3F4F6] p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3 text-[11px] text-[#9CA3AF]">
              <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-sm bg-[#E8317A] inline-block" /> Commission</span>
                ...
                return (
                  <div key={i} className="flex flex-col items-center gap-1 flex-1 group relative">
                    ...
                    <div className="w-full flex flex-col items-center gap-0.5">
                      ...
                      <div className="w-full rounded-t-sm bg-[#E8317A] absolute bottom-5" style={{ height: `${cPct}%` }} />
                    </div>
                    <span className="text-[9px] text-[#D1D5DB]">{d.label?.slice(0, 3)}</span>
                  </div>
                );
      ...
      <div className="grid lg:grid-cols-2 gap-5 mb-6">
        <div className="bg-white rounded-2xl border border-[#F3F4F6] p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3 text-[11px] text-[#9CA3AF]">
              <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-sm bg-[#E8317A] inline-block" /> Citizens</span>
              ...
              {an.userGrowth.slice(-14).map((d, i) => {
                ...
                return (
                  <div key={i} className="flex flex-col items-end gap-0.5 flex-1 group relative">
                    ...
                    <div className="w-full rounded-t-sm bg-[#E8317A] opacity-70" style={{ height: `${Math.max((d.citizens / maxC) * 100, 3)}%` }} />
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-2xl border border-[#F3F4F6] shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-[#F3F4F6] flex items-center justify-between">
            ...
            {an?.pendingActions && an.pendingActions.length > 0 && (
              <span className="text-[10px] font-bold bg-[#E8317A] text-white px-2 py-0.5 rounded-full">
        ...
        <div className="bg-white rounded-2xl border border-[#F3F4F6] shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-[#F3F4F6] flex items-center justify-between">
            ...
            <Link href="/admin/reviews" className="text-[11px] text-[#E8317A] font-semibold hover:underline">View all</Link>
          </div>
