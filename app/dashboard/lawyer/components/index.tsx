        ...
        <div className="border-[1.5px] border-[#F3F4F6] rounded-xl p-4 space-y-3">
            ...
            {(!existing || needsReupload) && (
                <div className="space-y-2">
                    <label className="flex items-center gap-2 h-10 px-3 rounded-lg border-[1.5px] border-dashed border-[#E5E7EB] text-[11px] text-[#9CA3AF] cursor-pointer hover:border-[#E8317A] transition-colors">
