  ...
  return (
    <div className="flex items-center gap-0 w-full">
      {labels.map((label, i) => {
        ...
        const lineColor = done ? "#9B2E3D" : "#E5E7EB";
          ...
          <React.Fragment key={label}>
            <div className="flex flex-col items-center gap-1 shrink-0">
              <div
                ...
                style={{
                  background: done ? "#9B2E3D" : active ? "#FFF0F5" : "#F3F4F6",
              ...
              <span
                ...
                style={{ color: done || active ? "#9B2E3D" : "#9CA3AF" }}
              >
                {label}
              </span>
            </div>
        ...
        <div className="flex-1 overflow-auto bg-[#F5F2EE] flex items-center justify-center p-4">
          {!doc.fileUrl ? (
            ...
            <div className="text-center py-10">
              ...
              <a href={doc.fileUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-xs font-semibold text-maroon-500 hover:underline mt-2">
      ...
      {caseBrief && (
        <div>
          ...
          <div className="rounded-xl border-[1.5px] border-[#FBCFE8] bg-[#FFF0F5] p-1">
            <DocRow doc={caseBrief} badge={{ label: "Prepared by our team", color: "#9B2E3D", bg: "#FFFFFF" }} />
          </div>
      ...
      {(clientDocs.length > 0 || firmDocs.length > 0) && (
        <div>
          ...
          <div className="space-y-2">
            ...
            {firmDocs.map((d, i) => (
              <DocRow key={`${d.name}-firm-${i}`} doc={d} badge={{ label: "From our team", color: "#9B2E3D", bg: "#FFF0F5" }} />
            ))}
          </div>
        </div>
      )}
              ...
              <div>
                ...
                <div className="bg-[#F9FAFB] rounded-xl border border-[#F3F4F6] p-4 flex items-center gap-3">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-1 text-[11px] font-semibold text-maroon-500 hover:underline shrink-0"
                  >
                  ...
                  {ratingSubmitted ? (
                    ...
                    <div className="bg-[#F9FAFB] rounded-xl border border-[#F3F4F6] p-5">
                      ...
                      <textarea
                        ...
                        className="w-full h-18 px-3 py-2.5 rounded-xl border-[1.5px] border-[#E5E7EB] text-[12px] text-[#111827] resize-none outline-none focus:border-maroon-500 placeholder:text-[#D1D5DB] transition-colors mb-3"
                        rows={3}
                      />
                      <button
    ...
    >
      ...
      {urgent && (
        <div
          ...
          style={{ background: "linear-gradient(90deg, #9B2E3D, #82212D, #9B2E3D)" }}
        />
      )}
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            {hasUnread && (
              <span className="flex items-center gap-1 text-[10px] font-bold text-maroon-500 bg-[#FFF0F5] border border-[#FBCFE8] px-2 py-0.5 rounded-full">
        ...
        <div className="flex items-center justify-between">
          ...
          {consult.status === "completed" && !consult.rating && (
            <span className="text-[11px] font-semibold text-maroon-500">Leave a review →</span>
          )}
        </div>
      </div>
    </button>
            ...
            <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl pointer-events-auto overflow-hidden">
              ...
              <div className="relative px-6 pt-6 pb-4 border-b border-gray-100">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-maroon-500/10 flex items-center justify-center">
                    <Shield size={20} className="text-maroon-500" />
                  </div>
                  <div>
              ...
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-maroon-500 hover:bg-[#d02b6c] rounded-lg transition-colors flex items-center justify-center gap-2"
                >
                  <Shield size={16} />
                  I Understand & Agree
                </button>
