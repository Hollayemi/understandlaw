...
const MATCH_STATUS_CFG: Record<MatchStatus, { label: string; sub: string; bg: string; text: string; dot: string }> = {
  ...
  recommended: { label: "Lawyers Ready", sub: "We've found lawyers for you — pick who you'd like to work with.", bg: "#FFF0F5", text: "#9D174D", dot: "#E8317A" },
  ...
  if (error || !request) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-[#F5F2EE] gap-3 px-6 text-center">
        ...
        <Link href="/dashboard/consultations" className="text-xs font-bold text-[#E8317A] hover:underline">
