            ...
            <div className="flex items-center gap-1 bg-white border border-[#F3F4F6] rounded-xl p-1 w-fit">
              {([
                ...
                >
                  ...
                  {!!opt.count && (
                    <span
                      className={`text-[10px] px-1.5 py-0.5 rounded-full font-bold ${mainTab === opt.v ? "bg-white/20 text-white" : "bg-[#FFF0F5] text-[#E8317A]"
                        }`}
                    >
                      {opt.count}
                    </span>
                  ...
                  {([
                    ...
                    return (
                      ...
                      >
                        ...
                        {count > 0 && (
                          <span
                            className={`text-[10px] px-1 py-0.5 rounded-full font-bold ${tab === opt.v ? "bg-[#E8317A] text-white" : "bg-[#F3F4F6] text-[#9CA3AF]"
                              }`}
                          >
                            {count}
                          </span>
