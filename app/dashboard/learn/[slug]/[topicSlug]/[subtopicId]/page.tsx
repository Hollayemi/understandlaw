      ...
      `}>
        <div className="p-4 border-b border-gray-200 flex items-center justify-between">
          <h3 className="font-bold text-gray-900 flex items-center gap-2">
            <Bookmark size={18} className="text-[#F97316]" />
                ...
                <div className="flex items-center justify-between mt-2 pt-2 border-t border-gray-200">
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      className="p-1.5 text-gray-400 hover:text-[#F97316] transition-colors rounded-lg hover:bg-[#F97316]/10"
  ...
  return (
    <button
      ...
      className={`w-full flex items-center gap-3 p-3 rounded-xl text-left transition-all group ${isActive
        ? "bg-gradient-to-r from-[#F97316]/10 to-transparent border-l-4 border-[#F97316]"
        : "hover:bg-gray-50"
        }`}
    >
      ...
      {isActive && (
        <ChevronRight size={14} className="text-[#F97316] flex-shrink-0" />
      )}
    </button>
  );
};
    ...
    for (const el of elements) {
      if (el.getAttribute('data-bookmark-id') === bookmark.id) {
        ...
        el.setAttribute('style',
          'background-color: rgba(232, 49, 122, 0.3); border-bottom: 3px solid #F97316; padding: 2px 0; cursor: pointer; transition: background-color 0.5s;'
        );
        setTimeout(() => {
          el.setAttribute('style', originalStyle ||
            'background-color: rgba(232, 49, 122, 0.15); border-bottom: 2px solid #F97316; padding: 2px 0; cursor: pointer; transition: background-color 0.2s;'
          );
        }, 1000);
        break;
      }
        ...
        <div className="flex items-center justify-between px-4 md:px-6 py-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="w-8 h-8 rounded-full bg-[#F97316]/10 flex items-center justify-center hover:bg-[#F97316]/20 transition-colors relative"
            >
              <Bookmark size={14} className="text-[#F97316]" />
              {bookmarks.length > 0 && (
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-[#F97316] text-white text-[8px] font-bold rounded-full flex items-center justify-center">
                  {bookmarks.length}
                </span>
              )}
            </button>
                ...
                <div className="p-6 border-b border-gray-100">
                  <div className="flex items-start justify-between flex-wrap gap-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        <Heart size={14} className={liked ? "fill-[#F97316]" : ""} />
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 mb-4">
                  <div className="flex items-center justify-between flex-wrap gap-3">
                    <div className="flex items-center gap-4">
                      ...
                      >
                        <Heart size={16} className={liked ? "fill-[#F97316]" : ""} />
                        Like ({likesCount})
                      </button>
                ...
                {nextTopic && (
                  <Link
                    ...
                    className={`flex-1 flex items-center justify-end gap-2 p-4 rounded-xl transition-all group ${allSubtopicsCompleted
                      ? "bg-gradient-to-r from-[#F97316]/10 to-[#EA580C]/10 border border-[#F97316]/20"
            ...
            <div className="lg:w-80 flex-shrink-0 sticky top-28">
              <div className="sticky top-28 space-y-5">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                  <div className="p-4 border-b border-gray-100">
                    <h3 className="font-bold text-gray-900 text-sm flex items-center gap-2">
                      <List size={14} className="text-[#F97316]" />
                      Lesson Sections
                    </h3>
                  </div>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-[#F97316] to-[#EA580C] text-white hover:shadow-lg transition-all"
                >
      ...
      {showAIChat && (
        <div className="fixed bottom-6 right-6 w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 z-50">
          <div className="flex items-center justify-between p-4 border-b border-gray-100">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#F97316] to-[#EA580C] flex items-center justify-center">
          ...
          <div className="p-4 border-t border-gray-100">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:border-[#F97316]"
              />
              <button className="px-3 py-2 bg-[#F97316] text-white rounded-lg">
                <Send size={14} />
              </button>
            </div>
          </div>
