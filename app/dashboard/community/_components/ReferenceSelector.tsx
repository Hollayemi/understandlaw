        ...
        <div className="relative">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#F97316]"
            />
            {modulesLoading && (
        ...
        <div className="relative">
          ...
          <div className="relative">
            <div
              ...
              className="w-full px-3 py-2 border border-gray-200 rounded-lg cursor-pointer hover:border-[#F97316] transition-colors flex items-center justify-between"
            >
