  ...
  if (!post) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        ...
        <Link href="/dashboard/community" className="text-[#F97316] font-semibold">
          Back to Community
        </Link>
      </div>
    );
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-3 mb-4 pb-4 border-b border-gray-100">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <Heart size={16} className={post.likedBy?.includes(post.author._id) ? "fill-[#F97316]" : ""} />
                {post.likes}
              </button>
            </div>
          </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#F97316] resize-none"
                  />
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <button
                      ...
                      className="px-4 py-1.5 bg-gradient-to-r from-[#F97316] to-[#EA580C] text-white rounded-lg text-sm font-semibold disabled:opacity-50"
                    >
                      <Send size={14} />
                    </button>
                  </div>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-400">
            <button onClick={onLike} className="flex items-center gap-1 hover:text-[#F97316]">
              <Heart size={12} /> {comment.likes}
            </button>
            <button onClick={() => setShowReply(!showReply)} className="hover:text-[#F97316]">
              Reply
            </button>
