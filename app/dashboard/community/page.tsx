...
export default function CommunityPage() {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-gray-50 p-4">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#E8317A] rounded-2xl to-[#ff6fa8] text-white">
        <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white text-[#E8317A] rounded-xl font-semibold text-sm hover:shadow-lg transition-all"
            >
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:border-[#E8317A]"
              />
            </div>
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value)}
              className="px-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:border-[#E8317A]"
            >
              {sortOptions.map(opt => (
                ...
                <div key={post._id} className="bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition-all">
                  <div className="p-5">
                    ...
                    <Link href={`/dashboard/community/${post._id}`}>
                      <h2 className="text-lg font-bold text-gray-900 mb-2 hover:text-[#E8317A] transition-colors line-clamp-2">
                        {post.title}
                      </h2>
                    </Link>
                    ...
                    {/* Reference Context */}
                    {post.reference && (
                      <div className="mb-3 p-2 bg-gray-50 rounded-lg border-l-4 border-[#E8317A]">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                      ...
                      <div className="flex items-center gap-3 text-xs text-gray-500">
                        <button 
                          ...
                          className="flex items-center gap-1 hover:text-[#E8317A] transition-colors"
                        >
