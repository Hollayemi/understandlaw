...
function ConversationsPageContent() {
  ...
  const stats = isLawyer ? [
    ...
    { label: "Unread", value: unreadTotal, color: "#9B2E3D", icon: MessageSquare },
        ...
        <div className="flex-shrink-0 px-5 py-4 border-b border-gray-100/80 bg-gradient-to-r from-white to-gray-50/50 sticky top-0 z-10">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-maroon-500 to-maroon-600 flex items-center justify-center shadow-lg shadow-maroon-500/20">
            ...
            <button
              onClick={() => refetch()}
              className="w-8 h-8 rounded-xl flex items-center justify-center text-gray-400 hover:text-maroon-500 hover:bg-maroon-500/10 transition-all duration-200 group"
            >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-9 pl-9 pr-9 rounded-xl border border-gray-200/80 text-[13px] outline-none focus:border-maroon-500 focus:ring-2 focus:ring-maroon-500/20 placeholder:text-gray-400 transition-all duration-200 bg-gray-50/80 hover:bg-white"
            />
            {search && (
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar px-1.5 py-2">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-12">
              <Loader2 size={28} className="animate-spin text-maroon-500" />
        ...
        {isCitizen && (
          <div className="flex-shrink-0 p-4 border-t border-gray-100/80 bg-gradient-to-r from-gray-50/50 to-white sticky bottom-0">
            <Link
              ...
              className="flex items-center justify-center gap-2.5 w-full py-3 rounded-xl text-[13px] font-semibold text-white hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-lg shadow-maroon-500/25 hover:shadow-xl hover:shadow-maroon-500/35"
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white h-screen overflow-hidden">
        ...
        <div className="flex-shrink-0 h-14 flex items-center px-4 md:px-6 border-b border-gray-100/80 bg-white/95 backdrop-blur-xl gap-3 sticky top-0 z-10">
          <button
            ...
            className="w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:bg-gray-100/80 hover:text-maroon-500 transition-all duration-200 md:hidden"
          >
            <Menu size={18} />
          </button>
