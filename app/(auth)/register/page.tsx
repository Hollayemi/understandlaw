      ...
      >
        ...
        >
          <Link href="/" className="inline-flex items-center gap-2">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #9B2E3D, #82212D)",
              }}
            >
        ...
        <AuthCard title="Create Account" subtitle="Start your legal journey today">
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                {(
                  ...
                  >
                    <input
                      ...
                      onChange={handleInputChange}
                      className="mt-0.5 w-4 h-4 accent-maroon-500 flex-shrink-0"
                    />
                    <span>
                      <span
                        className={`block text-sm font-semibold ${
                          formData.role === option.value ? "text-maroon-500" : "text-gray-800"
                        }`}
                      >
                        {option.label}
                      </span>
            ...
            <div className="flex items-start gap-3 pt-1">
              <input
                ...
                className="mt-0.5 w-4 h-4 rounded accent-maroon-500 flex-shrink-0"
              />
              <label htmlFor="terms" className="text-xs text-gray-500 leading-relaxed">
                I agree to the{" "}
                <Link href="/legal/terms" className="text-maroon-500 hover:underline font-medium">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/legal/privacy" className="text-maroon-500 hover:underline font-medium">
                  Privacy Policy
                </Link>
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full h-12 mt-1 rounded-full bg-maroon-500 hover:bg-maroon-600 disabled:opacity-60 text-white text-sm font-bold transition-all hover:shadow-lg hover:shadow-pink-200 flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
          ...
          <p className="text-center text-xs text-gray-500 mt-6">
            ...
            <Link href="/login" className="text-maroon-500 font-semibold hover:underline">
              Sign in
            </Link>
          </p>
        </AuthCard>
