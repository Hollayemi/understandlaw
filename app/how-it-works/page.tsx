    ...
    <HomeWrapper>
      ...
      <section className="bg-white pt-14 pb-16 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#7C3AED] mb-3">How It Works</p>
          <h1
            className="text-[clamp(48px,7vw,80px)] leading-none tracking-[0.01em] text-gray-900 uppercase mb-4"
            style={{ fontFamily: "var(--font-bebas)" }}
          >
            FROM CONFUSION<br />
            <span style={{ color: "#7C3AED" }}>TO CLARITY</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            <div className="inline-flex items-center gap-2 bg-pink-50 border border-pink-100 px-3 py-1.5 rounded-full mb-4">
              ...
              <span className="text-xs font-semibold text-[#7C3AED]">For Citizens</span>
            </div>
            <h2
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            <Link
              href="/learn"
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#7C3AED] text-white text-sm font-bold hover:bg-[#5B21B6] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-pink-200 transition-all"
            >
              Start Learning Free
      ...
      <section id="lawyers" className="bg-[#F3F3F3] py-20 xl:py-28">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            ...
            >
              BUILD YOUR<br />
              <span style={{ color: "#7C3AED" }}>CLIENT BASE</span>
            </h2>
            <p className="text-sm text-gray-500 mt-3 max-w-lg">
          ...
          <div className="mt-6">
            <Link
              href="/lawyers/join"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#7C3AED] text-white text-sm font-bold hover:bg-[#5B21B6] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-pink-200 transition-all"
            >
              Apply as a Lawyer →
            </Link>
          </div>
      ...
      <section className="bg-white py-20 xl:py-28">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            ...
            <Link href="/contact" className="text-sm font-semibold text-[#7C3AED] hover:underline">
              Contact our team →
            </Link>
          </div>
        </div>
...
function FAQItem({ q, a }: { q: string; a: string }) {
  return (
    <details className="group bg-gray-50 border border-gray-100 rounded-2xl overflow-hidden">
      <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer list-none font-semibold text-sm text-gray-900 hover:text-[#7C3AED] transition-colors">
        {q}
        <svg
