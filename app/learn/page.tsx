    ...
    <HomeWrapper>
      ...
      <section className="bg-white pt-14 pb-12 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#7C3AED] mb-3">Legal Learning Module</p>
              <h1
              ...
              >
                ...
                <span style={{ color: "#7C3AED" }}>ABOUT YOU</span>
              </h1>
            </div>
            <div>
      ...
      <section className="bg-[#F3F3F3] py-6 border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="flex gap-3">
            ...
            <Link
              href="/register"
              className="flex items-center gap-2 px-5 h-12 rounded-xl bg-[#7C3AED] text-white text-sm font-semibold hover:bg-[#5B21B6] transition-colors whitespace-nowrap flex-shrink-0"
            >
              Save Progress
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-5">
            {CATEGORIES.map((cat) => (
              ...
              >
                ...
                <h3
                  className="font-bold text-gray-900 text-base mb-2 group-hover:text-[#7C3AED] transition-colors"
                  style={{ fontFamily: "var(--font-dm-sans)" }}
                >
                  {cat.title}
                </h3>
      ...
      <section className="bg-white py-16 border-t border-gray-100">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#7C3AED] mb-3">Can't find it?</p>
          <h2
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/learn/request"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-[#7C3AED] text-white text-sm font-bold hover:bg-[#5B21B6] transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-pink-200"
            >
              Request a Topic
            </Link>
            <Link
