    ...
    <HomeWrapper>
      ...
      <section className="bg-white pt-14 pb-12 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 items-end">
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#7C3AED] mb-3">Legal Library</p>
              <h1
                className="text-[clamp(48px,7vw,76px)] leading-none tracking-[0.01em] text-gray-900 uppercase"
                style={{ fontFamily: "var(--font-bebas)" }}
              >
                THE LAW,<br />
                <span style={{ color: "#7C3AED" }}>IN YOUR LANGUAGE</span>
              </h1>
            </div>
            <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full h-12 pl-11 pr-4 rounded-xl border-[1.5px] border-gray-200 text-sm text-gray-900 bg-white outline-none focus:border-[#7C3AED] placeholder:text-gray-400 transition-colors"
              />
            </div>
            <select className="h-12 px-4 rounded-xl border-[1.5px] border-gray-200 text-sm text-gray-700 bg-white outline-none focus:border-[#7C3AED] transition-colors">
      ...
      <section className="bg-[#F3F3F3] py-12 xl:py-16">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <select className="h-9 px-3 rounded-lg border-[1.5px] border-gray-200 text-xs text-gray-700 bg-white outline-none focus:border-[#7C3AED]">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-5">
            {FEATURED_ACTS.map((act) => (
              ...
              >
                ...
                <h3
                  className="font-bold text-gray-900 text-base mb-1 group-hover:text-[#7C3AED] transition-colors leading-snug"
      ...
      <section className="bg-[#111827] py-14">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#7C3AED] mb-3">Registered Users</p>
          <h2
          ...
          <Link
            href="/auth"
            className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#7C3AED] text-white text-sm font-bold hover:bg-[#5B21B6] transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-pink-900/30"
          >
            Create Free Account →
          </Link>
        </div>
